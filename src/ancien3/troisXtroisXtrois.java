                    ...
                    for (i = 0; i < 3; i = i + 2) {
                        for (j = 0; j < 3; j = j + 2) {
                            ...
                            if (j == 0)
                                ...
                                l = 0;
                            if (tab[i][j][0].getClass().getName().equals(joueurStr) && tab[1][1][1].getClass().getName().equals(joueurStr) && tab[k][l][2].getClass().getName().equals(nameVide)) {
                                tab[k][l][2] = ordiPion;
                                boucle = false;
                                break;
                            }
                            if (tab[k][l][2].getClass().getName().equals(joueurStr) && tab[1][1][1].getClass().getName().equals(joueurStr) && tab[i][j][0].getClass().getName().equals(nameVide)) {
                                tab[i][j][0] = ordiPion;
                                boucle = false;
                                break;
                            }
                            if (tab[k][l][2].getClass().getName().equals(joueurStr) && tab[i][j][0].getClass().getName().equals(joueurStr) && tab[1][1][1].getClass().getName().equals(nameVide)) {
                                tab[1][1][1] = ordiPion;
                                boucle = false;
                                break;
                            }
