...
public class quatreXquatre extends grille{
	...
	/*	if(tab[0][0].getClass().getName().equals(JoueurStr) && tab[0][1].getClass().getName().equals(JoueurStr) && tab[0][2].getClass().getName().equals(JoueurStr) && tab[0][3].getClass().getName().equals(nameVide))
				tab[0][3] = ordiPion;
			else
			if(tab[0][0].getClass().getName().equals(JoueurStr) && tab[0][1].getClass().getName().equals(JoueurStr) && tab[0][3].getClass().getName().equals(JoueurStr) && tab[0][2].getClass().getName().equals(nameVide))
				tab[0][2] = ordiPion;	
			else
			if(tab[0][0].getClass().getName().equals(JoueurStr) && tab[0][3].getClass().getName().equals(JoueurStr) && tab[0][2].getClass().getName().equals(JoueurStr) && tab[0][1].getClass().getName().equals(nameVide))
				tab[0][1] = ordiPion;
			else
			if(tab[0][3].getClass().getName().equals(JoueurStr) && tab[0][1].getClass().getName().equals(JoueurStr) && tab[0][2].getClass().getName().equals(JoueurStr) && tab[0][0].getClass().getName().equals(nameVide))
				tab[0][0] = ordiPion;	
			else	
	*/		
