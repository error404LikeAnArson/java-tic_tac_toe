...
public class troisXtrois extends grille{
	...
	public void ordiCassicEasy (boolean pion){
        ...
        rond testRond = new rond();
        String nameRond = testRond.getClass().getName();
        croix testCroix = new croix();
        String nameCroix = testCroix.getClass().getName();
        pion ordiPion;
        String ordiStr;
		...
		ordiStr = ordiPion.getClass().getName();
			...
			if(tab[0][1].getClass().getName().equals(ordiStr) && tab[0][2].getClass().getName().equals(ordiStr))
				tab[0][0] = ordiPion;
			else
        	if(tab[0][0].getClass().getName().equals(ordiStr) && tab[0][2].getClass().getName().equals(ordiStr))
        		tab[0][1] = ordiPion;
        	else
			if(tab[1][0].getClass().getName().equals(ordiStr) && tab[1][1].getClass().getName().equals(ordiStr))
				tab[1][2] = ordiPion;
			else
			if(tab[1][1].getClass().getName().equals(ordiStr) && tab[1][2].getClass().getName().equals(ordiStr))
				tab[1][0] = ordiPion;
			else
			if(tab[1][0].getClass().getName().equals(ordiStr) && tab[1][2].getClass().getName().equals(ordiStr))
				tab[1][1] = ordiPion;
			else
			if(tab[2][0].getClass().getName().equals(ordiStr) && tab[2][1].getClass().getName().equals(ordiStr))
				tab[2][2] = ordiPion;
			else
			if(tab[2][1].getClass().getName().equals(ordiStr) && tab[2][2].getClass().getName().equals(ordiStr))
				tab[2][0] = ordiPion;
			else
			if(tab[2][0].getClass().getName().equals(ordiStr) && tab[2][2].getClass().getName().equals(ordiStr))
				tab[2][1] = ordiPion;
			...
			if(tab[1][0].getClass().getName().equals(ordiStr) && tab[2][0].getClass().getName().equals(ordiStr))
				tab[0][0] = ordiPion;
			else
			if(tab[0][0].getClass().getName().equals(ordiStr) && tab[2][0].getClass().getName().equals(ordiStr))
				tab[1][0] = ordiPion;
			else
			if(tab[0][1].getClass().getName().equals(ordiStr) && tab[1][1].getClass().getName().equals(ordiStr))
				tab[2][1] = ordiPion;
			else
			if(tab[1][1].getClass().getName().equals(ordiStr) && tab[2][1].getClass().getName().equals(ordiStr))
				tab[0][1] = ordiPion;
			else
			if(tab[0][1].getClass().getName().equals(ordiStr) && tab[2][1].getClass().getName().equals(ordiStr))
				tab[1][1] = ordiPion;
			else
			if(tab[0][2].getClass().getName().equals(ordiStr) && tab[1][2].getClass().getName().equals(ordiStr))
				tab[2][2] = ordiPion;
			else
			if(tab[1][2].getClass().getName().equals(ordiStr) && tab[2][2].getClass().getName().equals(ordiStr))
				tab[0][2] = ordiPion;
			else
			if(tab[0][2].getClass().getName().equals(ordiStr) && tab[2][2].getClass().getName().equals(ordiStr))
				tab[1][2] = ordiPion;

			//diagonale
			else
			if(tab[0][0].getClass().getName().equals(ordiStr) && tab[2][2].getClass().getName().equals(ordiStr))
				tab[1][1] = ordiPion;
			else
			if(tab[1][1].getClass().getName().equals(ordiStr) && tab[2][2].getClass().getName().equals(ordiStr))
				tab[0][0] = ordiPion;
			else
			if(tab[0][0].getClass().getName().equals(ordiStr) && tab[1][1].getClass().getName().equals(ordiStr))
				tab[2][2] = ordiPion;
			else
			if(tab[0][2].getClass().getName().equals(ordiStr) && tab[2][0].getClass().getName().equals(ordiStr))
				tab[1][1] = ordiPion;
			else
			if(tab[1][1].getClass().getName().equals(ordiStr) && tab[0][2].getClass().getName().equals(ordiStr))
				tab[2][0] = ordiPion;
			else
			if(tab[2][0].getClass().getName().equals(ordiStr) && tab[1][1].getClass().getName().equals(ordiStr))
				tab[0][2] = ordiPion;
	...
	public void easyClassicT (boolean pion){
		int tempoVict = 0;
		System.out.println("");
			...
			if(tempoVict == 1){
				...
				if(tempoVict == 2){
					...
					if(tempoVict == 0) {
						...
						System.out.println("erreur tempoVict easyClassicT");
						break;
					}
				}
			}
	...
	public void mediumClassicT (boolean pion){
		
		return;
	}
	
	public void hardClassicT (boolean pion){
		...
		if (affichage == 0){
			switch(levelGame){
				...
				case 'H':
					...
					break;
				default	:
					System.out.println("Erreur level classic terminal switch");
					break;
			}
		}	
